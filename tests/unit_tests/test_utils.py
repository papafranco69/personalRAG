from personal_rag.core.utils import pop_docs_upto_limit
from langchain.docstore.document import Document
from personal_rag.core.debug import FakeChatModel
from langchain.chains.qa_with_sources.loading import _load_stuff_chain
from personal_rag.core.prompts import STUFF_PROMPT
